            ...
            >
              ...
              >
                <template #body="slotProps">
                  ...
                  />
                  <Button
                    v-bind:title="cancelMsg"
                    icon="pi pi-times-circle"
                    class="p-button-rounded p-button-danger mr-2"
                    @click="cancel(slotProps)"
                  />
                </template>
              </Column>
            </DataTable>
...
export default {
  ...
  methods: {
    async fetchRecord() {
      ...
      const res = await this.callApiwParam("post", "/approvals/getRequests",this.form);
    ...
    view(data) {
      let src = data.data.id,
        alt = data.data.id;
      window.location.href = this.$env_Url + "/approvals/view/" + alt;
    },
    cancel(data) {
      let src = data.data.id,
        alt = data.data.id;
