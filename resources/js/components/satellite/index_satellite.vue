<template>
          ...
          <div>
            <nav aria-label="breadcrumb">
              <ol class="breadcrumb breadcrumb-style1 mg-b-5">
                <li class="breadcrumb-item active" aria-current="page">OSTR</li>
                <li class="breadcrumb-item active" aria-current="page">Satellites</li>
              </ol>
            </nav>
            <h4 class="mg-b-0 tx-spacing--1">Manage Satellites</h4>
          </div>
        </div>
    ...
    export default {
      ...
      methods: {
        ...
        addNew() {
          window.location.href = this.$env_Url + "/satellites/create";
        },
    
        editRole(data) {
            let src = data.data.id,
            alt = data.data.id;
            window.location.href = this.$env_Url + "/satellites/edit/" + alt;
        },
