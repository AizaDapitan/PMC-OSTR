            ...
            <div class="portlet light bordered">
                ...
                <div class="portlet-title" id="title">
                    <div class="caption">
                        ...
                        <span class="caption-subject font-blue-hoki bold uppercase"> List of User Access Rights</span>
                    </div>
                    ...
                    <div class="portlet-title">
                        ...
                        <div class="actions">
                            <div class="form-group form-inline" style="display:inline;margin-right:10px">
                                ...
                                <label class="control-label" style="margin-right:20px; margin-left:10px; margin-top:10px">User Name </label>
